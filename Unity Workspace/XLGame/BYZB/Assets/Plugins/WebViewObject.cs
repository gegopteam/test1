...
public class WebViewObject : MonoBehaviour
{
...
#elif UNITY_ANDROID
        Debug.Log("~~~~~~~Log webView Init "+name+" : "+transparent+" : "+ua);
...
#elif UNITY_IOS
        if (webView == IntPtr.Zero){
            print("webView webView = "+ 000000);
            return;
        }
        _CWebViewPlugin_SetMargins(webView, left, top, right, bottom);
        print("webView webView = "+webView);
        print("webView left = "+left);
        print("webView top = "+top);
        print("webView right = "+right);
        print("webView bottom = "+bottom);
#elif UNITY_ANDROID
        if (webView == null){
            print("webView webView = null");
            return;
        }
    ...
    {
        Debug.Log("~~~~~ CallFromJS message = "+ message);
        if (onJS != null)
        {
#if !UNITY_ANDROID
