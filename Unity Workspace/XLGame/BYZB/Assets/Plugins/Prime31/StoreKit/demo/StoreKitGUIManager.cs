...
namespace Prime31
{
	...
	{
#if UNITY_IOS || UNITY_TVOS || pc
		private List<StoreKitProduct> _products;


		void Start()
		{
			Debug.Log("StoreKitGUIManager Start");
		...
		void OnGUI()
		{
			Debug.Log("StoreKitGUIManager OnGUI");
			beginColumn();
		...
		{
			Debug.Log("StoreKitGUIManager coreFeatureButtonsGUI");
		...
		{
			Debug.Log("StoreKitGUIManager deferredPaymentsGUI");
