...
//		public MeiPai meiPai;
	...
	public class QQ : DevInfo 
	{
		...
		public string AppId = "1106689677";
		public string AppKey = "pI1H5NRgaFXUystm";
		public bool ShareByAppClient = true;
		#elif UNITY_IOS
		public const int type = (int) PlatformType.QQ;
		public string app_id = "1106469913";
		public string app_key = "nLPCSAHySCTGxn7z";
		public string auth_type = "both";  //can pass "both","sso",or "web" 
		#endif
	}
	...
	public class QZone : DevInfo 
	{
		...
		public string AppId = "1106469913z";
	...
	{	
		...
		public string AppId = "wx9258b8a8a4fbc9d4";
		public string AppSecret = "6041730364cd17d3c6f80a70d270ea78";
		public string UserName = "gh_afb25ac019c9@app";
		public string Path = "/page/API/pages/share/share";
		public bool BypassApproval = true;
		#elif UNITY_IOS
		public const int type = (int) PlatformType.WeChat;
		public string app_id = "wx9258b8a8a4fbc9d4";
		public string app_secret = "6041730364cd17d3c6f80a70d270ea78";
		#endif
	}
